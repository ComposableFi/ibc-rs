...
use super::validate::*;
use crate::{
	core::{ics02_client::client_type::ClientType, ics24_host::error::ValidationError},
	prelude::*,
};
...
impl ChainId {
	...
	pub fn new(name: String, version: u64) -> Self {
		Self { id: format!("{}-{}", name, version), version }
	}

	pub fn from_string(id: &str) -> Self {
		let version = if Self::is_epoch_format(id) { Self::chain_version(id) } else { 0 };

		Self { id: id.to_string(), version }
	}
