...
use crate::{
	core::{
		ics02_client::{client_type::ClientType, error::Error, header::AnyHeader, height::Height},
	...
	for tag in &event.attributes {
		...
		match key {
			...
			CLIENT_TYPE_ATTRIBUTE_KEY =>
				attr.client_type =
					value.parse().map_err(|_| Error::unknown_client_type(value.to_string()))?,
...
mod tests {
	use super::*;
	use crate::{core::ics02_client::header::Header, mock::header::MockHeader};
